        ...
        <div className="">
            ...
            >
                <div style={{ display: "flex" }}>
                    <div>
                        <img src={qrCodeSrc} />
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}><img style={{ marginRight: "5px", width: "20px" }} src="https://cdn.youyi.asia/wechatlogo.png" />请使用微信扫码支付</div>
                    </div>
