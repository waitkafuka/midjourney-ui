...
## 二、活动规则
通过本站绘画生成的作品（不限使用 midjourney 还是 DALLE2），分享到公共区（[https://arkit.com.cn/art/paintings/](../paintings/)），经网友点赞投票，每月选出点赞最多的前 10 名选手。
...
`
// ## 本站公众号
// [![](https://c.arkit.com.cn/stuff/qrcode.jpg)](https://c.arkit.com.cn/stuff/qrcode.jpg)
// ## 微信群
// ![](https://c.arkit.com.cn/stuff/group.png)
