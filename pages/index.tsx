...
const Index: React.FC = () => {
  ...
  //   text: '测试',
  //   img: 'https://o-c-h.arkit.com.cn/attachments/1100632439031877675/1109823643304853564/waitkafuka_an_asian_woman_poses_for_a_portrait_in_the_style_of__61423d59-7663-42d4-b972-eb4a2cf1e6d6.png?x-oss-process=style/scale_500',
  //   progress: 'done',
  //   hasTag: true,
  // }]);
  const [messages, setMessages] = useState<Message[]>([]);
  ...
  return (
    ...
    <div className="w-full mx-auto px-4 h-full overflow-y-hidden list-input-container">
      ...
      {/* <div className="qr-code-modal" style={{ display: showQrcodeModal ? 'block' : 'none' }}>
        ...
        <p>加入绘画交流群：</p>
        <img src="//c.arkit.com.cn/stuff/1.png" alt="" />
      </div> */}
      {/* <List
          ...
          {messages.map(({ text, img, progress, hasTag, content, msgID, msgHash }, index) => <div className="img-list-item" key={index}>
            ...
            <div className="workspace-img-container" style={{ width: `${baseWidth}px`, height: getImgCalcHeight(img, text) }}>
              ...
              {!img && <div style={{ textAlign: "center" }}>
                <img style={{ width: "130px" }} src="https://c.arkit.com.cn/stuff/default.svg" alt="" /> <br />
